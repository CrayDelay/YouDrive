...
import {passwordRegex, passwordCheckerHelper, isFormItemValid, numberRegex, } from '@youdrive/helpers';
import {countriesData, usStatesData} from '@youdrive/data/dummy';
...
export class AuthBookADemoComponent implements OnInit {
  ...
  public step1Valid = false;
  public step2Valid = false;
  public step1Loading = false;
  public step2Loading = false;
  public step3Loading = false;
